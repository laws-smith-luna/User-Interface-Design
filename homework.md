# Homework Tracker - Spring 2026

Shared tracker for both courses. Verify exact due dates on Canvas.
...
| Module | Week of | Assignment | Status |
|--------|---------|------------|--------|
| 2 | 1/27 | Violations of Norman's Principles | Done |
| 3 | 2/3 | Design a New Consumer Software Product | Done |
| 4 | 2/10 | Contextual Inquiry | Done |
| 5 | 2/17 | Wireframes for a Consumer App | Done |
...
| Module | Week of | Assignment | Status |
|--------|---------|------------|--------|
| 2 | 1/27 | Initial Prototype | Done |
| 4 | 2/10 | Heuristic Evaluation | Done |
...
| # | Module | Week of | Assignment | Team? | Status |
|---|--------|---------|------------|-------|--------|
| 1 | 3 | 2/3 | Writing JUnit Tests | Individual | Done |
| 2 | 4 | 2/10 | RankingService Test Doubles | Team | Done |
| 3 | 6 | 2/24 | CalMutants Input Space Partitioning | Team | Done |
| 4 | 8 | 3/17 | LinkedList Statement Coverage | Team | Done |
| 5 | 9 | 3/24 | Testing the 737 MAX MCAS System | Team | Not started |
| 6 | 14 | 4/28 | Software Testing Literature Review | Team | Upcoming |

### Quizzes (40%)

Weekly, open-book. 10 highest of 13 count (3 lowest dropped).

### Other

| Type | Week of | Details | Status |
|------|---------|---------|--------|
| Final Exam | 5/5 | Due 5/11, 25% | Upcoming |
