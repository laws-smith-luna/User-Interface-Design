"""Build writeup.pdf from writeup.md using Python-markdown + Edge headless."""
import subprocess
import sys
...
p[align="center"] { text-align: center; margin-top: 1em; margin-bottom: 1em; }
@page { size: letter; margin: 0.7in; }
"""

def main():
    md_text = SRC.read_text(encoding="utf-8")
    # Let Python-Markdown pass through raw HTML (default), enable tables/fenced-code for safety
